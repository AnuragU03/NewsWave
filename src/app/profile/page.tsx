  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <header className="mb-8">
        ...
        <p className="text-lg text-muted-foreground mt-1">Manage your NewsWave account and preferences.</p>
      </header>
        ...
        <div className="flex-grow space-y-8 w-full">
          <Tabs defaultValue="account" className="w-full">
            <TabsList className="grid w-full grid-cols-2 md:grid-cols-3 mb-6">
              ...
              <TabsTrigger value="avatar" className="font-medium">
                <Camera className="mr-2 h-4 w-4" /> Avatar
              </TabsTrigger>
              <TabsTrigger value="rewards" className="font-medium">
